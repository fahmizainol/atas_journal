...
KPIS: list[dict] = [
    ...
    {"key": "ny_middle_band_occupancy", "label": "NY middle-band occupancy (±1σ)", "pct": True},
    {"key": "gx_middle_band_occupancy", "label": "Globex middle-band occupancy (±1σ)", "pct": True},
    {"key": "upper_wrap_occupancy", "label": "Globex wraps NY upper channel", "pct": True},
    {"key": "upper_dev1_gap_sigma", "label": "NY−Globex upper dev1 gap (σ)"},
    {"key": "gx_upper_rescue_ratio", "label": "Globex +1σ rescues broken NY +1σ", "pct": True},
